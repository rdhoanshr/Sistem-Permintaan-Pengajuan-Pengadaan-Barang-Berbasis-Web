...
<head>
  ...
  <title><?= $title; ?></title>
  <link href="<?= base_url() ?>/assets/img/favicon-16x16.png" rel="icon">
  ...
  <!--[if lt IE 9]>
  <script src="<?= base_url(); ?>assets/AdminLTE/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="<?= base_url(); ?>assets/AdminLTE/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
