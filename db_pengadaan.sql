...
-- Membuang data untuk tabel db_pengadaan.detail_pengajuan: ~6 rows (lebih kurang)
...
-- Membuang data untuk tabel db_pengadaan.penyerahan_barang: ~2 rows (lebih kurang)
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `nama_lengkap`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `id_unit`, `id_vendor`, `ttd`, `foto`) VALUES
	(1, '127.0.0.1', 'staff', 'Putri Wapa, A.Md, Tem', '$2y$10$aBtR.PqzP0FMJGXFCZKK8uDg9CvaSrrHwGW5/0/soE6jxle84RV7K', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1697107297, 1, 'Admin', 'istrator', 'ADMIN', '0', NULL, NULL, '1103417904.jpg', 'user1.png'),
	(6, '::1', 'kabag', 'Indra Zulkhan , SE', '$2y$10$HGBa.hKuR5RQL5yux0YEyuAvycRDch4oXRLmR2ONtp1wFcP7RlT4i', 'kabag@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1693785028, 1697103304, 1, NULL, NULL, NULL, NULL, NULL, NULL, 'user.png', ''),
	...
	(14, '::1', 'direktur', 'dr. Rifqiannor, MARS', '$2y$10$gkQAk11y99jyBlLzXsy2jerrq09DPRNpeZ/E5WSxcLLUP.TOfYKIi', 'direktur@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1694070426, 1697103378, 1, NULL, NULL, NULL, NULL, NULL, NULL, 'WhatsApp_Image_2023-09-01_at_19_05_58_(1).jpeg', NULL);
